...
<body>
  ...
  <div class="row">
        <div class="col-lg-12">
          <h1 class="big-heading">Search Answers for your Questions at Instant</h1>
          <form class="form-inline search-bar">
            <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search">
            <button class="btn btn-dark btn-outline-light my-2 my-sm-0" type="submit">Search</button>
          </form>
          <a href="login.php"><button type="button" class="btn btn-dark btn-lg signin-button">Log In</button></a>
          <a href="signup.php"><button type="button" class="btn btn-dark btn-lg signup-button">Sign Up</button></a>
        </div>
      </div>
